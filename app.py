...
path=r"C:\Users\koush\anaconda3\flights-sagemaker\data\train.csv"
...
#print(preprocessor.fit_transform(X_train,y_train).columns)
...
st.title("Flights Prices Prediction - Streamlit")
...
#saved_prepros=joblib.load('preprocessor.joblib')
#x_new_pre=saved_prepros.transform(x_new)
#x_new_pre=np.delete(x_new_pre,6,axis=1)
#print(x_new_pre)
...
if st.button("Predict"):
	...
	with open(r"C:\Users\koush\anaconda3\flights-sagemaker\xgboost-model", "rb") as f:
		model = pickle.load(f)
